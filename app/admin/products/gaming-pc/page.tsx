...
import { 
    ...
    Loader2, Package, Monitor, ArrowLeft, ChevronDown, Check
} from "lucide-react";
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3">
                        <Monitor className="text-yellow-400" /> {mainCategory}
                    </h1>
                    <p className="text-zinc-500 mt-1">Manage high-performance {mainCategory.toLowerCase()} and inventory.</p>
                </div>
                <button 
                    onClick={() => {
                        setEditingProduct(null);
            ...
            {loading ? (
                ...
                <div className="bg-zinc-900/50 border-2 border-dashed border-zinc-800 rounded-3xl p-20 text-center">
                    ...
                    <p className="text-zinc-500 mt-2">Ready to list some powerful hardware?</p>
                </div>
            ) : (
